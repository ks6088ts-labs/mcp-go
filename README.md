[![test](https://github.com/ks6088ts-labs/mcp-go/actions/workflows/test.yaml/badge.svg?branch=main)](https://github.com/ks6088ts-labs/mcp-go/actions/workflows/test.yaml?query=branch%3Amain)

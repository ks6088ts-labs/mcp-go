...
LDFLAGS ?= '-s -w \
	-X "github.com/ks6088ts-labs/mcp-go/internal.Revision=$(GIT_REVISION)" \
	-X "github.com/ks6088ts-labs/mcp-go/internal.Version=$(GIT_TAG)" \
'

# Docker
DOCKER_REPO_NAME ?= ks6088ts
DOCKER_IMAGE_NAME ?= mcp-go
DOCKER_COMMAND ?=
